    ...
    return (
        ...
        <View style={GlobalStyles.cajaAzul}>
            <View style={{ margin: 10 }}>
                ...
                />
                <TextInput 
                    style={GlobalStyles.inputRescate}
                    placeholder="Buscar ubicación..." 
                    placeholderTextColor={Colors.blueDark}
                />
                <Text style={GlobalStyles.textoinfoUbi}>
                    La ubicación se añadirá cuando se seleccione en el mapa.
                </Text>
            </View>
        </View>
        ...
        <View style={{ width: '90%' }}>
            <TextInput 
                ...
                style={GlobalStyles.input2Rescate} 
                placeholderTextColor={Colors.blueDark}
            />
